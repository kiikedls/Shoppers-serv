...
class ItemController extends Controller
{
    public function index($categoryId)
    {
        ...
        $items=Item::OfCategory($categoryId)->paginate();
        if (count($items)) {
        ...
        return response()->json(
            $data = [
                'message'=>'esta lista de compras no cuenta con articulos añadidos'
            ],
            $status = 200
        );
    }
    ...
    public function store(Request $req, $categoryId)
    {
        ...
        $NewItem = $req->User()->addItem(new Item($req->all()), $categoryId);
    ...
    {
        $category = $req->User()->categories()->find($categoryId);
    ...
    public function update(Request $req, $categoryId, $itemId)
    {
        ...
        $existingCategory = $req->User()->categories()->find($categoryId);
